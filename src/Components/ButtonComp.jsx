const ButtonComp = ({ type = null, icon = null, name, onClick, className = "" }) => {
    return (
        <button
            type={type}
            onClick={onClick}
            className={`btn m-2  px-6 py-2 text-white bg-green-600 rounded-md shadow-md transition duration-200 
